    ...
    people: [
      {
        name: "พี่ไกด์",
        description:
          "จบการศึกษาจากคณะวิศวกรรมศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย · เจ้าของ Software House เชี่ยวชาญงานพัฒนาซอฟต์แวร์ เว็บไซต์ และระบบ AI อย่างลึกซึ้ง · Co Author งานวิจัยด้าน AI ในงานประชุมวิชาการระดับสูงสุด Tier 1 ทั้ง ACL และ EMNLP รวม 3 งานวิจัย",
    ...
    people: [
      {
        name: "พี่จีจี้",
        description:
          "นิสิตคณะวิศวกรรมศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย (CEDT) · มีประสบการณ์ด้าน Competitive Programming เข้าร่วมค่าย สอวน.คอมพิวเตอร์ 3 ปีซ้อน ตั้งแต่ปี 2564 (ค่าย 2) และได้เป็นผู้แทนศูนย์ในการแข่งขัน TOI 19 และ 20 (ปี 2565 และ 2566) พร้อมประสบการณ์ติวนักเรียนเตรียมสอบโอลิมปิกวิชาการคอมพิวเตอร์โดยตรง",
        role: "ติวเตอร์ สอวน. คอมพิวเตอร์ & Competitive Programming",
