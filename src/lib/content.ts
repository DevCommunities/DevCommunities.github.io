...
export const tutors: Tutor[] = About.flatMap((group) => group.people).map(
  (p, i) => {
    ...
    return {
      ...
      availability:
        [
          "เสาร์ 09:00 ถึง 12:00",
          "อาทิตย์ 13:00 ถึง 16:00",
          "เสาร์ 13:00 ถึง 16:00",
          "อาทิตย์ 09:00 ถึง 12:00",
          "จันทร์ถึงศุกร์ 18:00 ถึง 20:00",
        ][i % 5],
      achievements: isGigi
        ? [
            "ผู้แทนศูนย์ สอวน. คอมพิวเตอร์ 2 ปีซ้อน (TOI 19 และ 20 ในปี 2565 และ 2566)",
        ...
        : isSayHi
          ...
          : isChokdee
            ...
            : isMookrob
              ? "CEO บริษัท Startup 'Remetrix' ที่ Spin off จากจุฬาลงกรณ์มหาวิทยาลัย"
              : isGuide
